...
class Roberta(nn.Module):
    def __init__(self, name, outdim, freeze=False) -> None:
        ...
        roberta_dir = repo_root / "model_zoo" / "roberta-base"
        self.body = RobertaModel.from_pretrained(str(roberta_dir))
        self.tokenizer = RobertaTokenizerFast.from_pretrained(str(roberta_dir))
